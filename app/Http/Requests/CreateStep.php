...
class CreateStep extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'childstep2_title' => 'required_with:childstep3_title,childstep3_content|required_if:number_of_childstep,2,3,4,5,6,7,8,9,10|max:255',
            'childstep2_content' => 'required_with:childstep3_title,childstep3_content|required_if:number_of_childstep,2,3,4,5,6,7,8,9,10|max:255',
            'childstep2_img' => 'file|image|mimes:jpeg,png,jpg,gif|max:2048',
            'childstep2_required-time' => 'nullable|integer|max:255',

            'childstep3_title' => 'required_with:childstep4_title,childstep4_content|required_if:number_of_childstep,3,4,5,6,7,8,9,10|max:255',
            'childstep3_content' => 'required_with:childstep4_title,childstep4_content|required_if:number_of_childstep,3,4,5,6,7,8,9,10|max:255',
            'childstep3_img' => 'file|image|mimes:jpeg,png,jpg,gif|max:2048',
            'childstep3_required-time' => 'nullable|integer|max:255',

            'childstep4_title' => 'required_with:childstep5_title,childstep5_content|required_if:number_of_childstep,4,5,6,7,8,9,10|max:255',
            'childstep4_content' => 'required_with:childstep5_title,childstep5_content|required_if:number_of_childstep,4,5,6,7,8,9,10|max:255',
            'childstep4_img' => 'file|image|mimes:jpeg,png,jpg,gif|max:2048',
            'childstep4_required-time' => 'nullable|integer|max:255',

            'childstep5_title' => 'required_with:childstep6_title,childstep6_content|required_if:number_of_childstep,5,6,7,8,9,10|max:255',
            'childstep5_content' => 'required_with:childstep6_title,childstep6_content|required_if:number_of_childstep,5,6,7,8,9,10|max:255',
            'childstep5_img' => 'file|image|mimes:jpeg,png,jpg,gif|max:2048',
            'childstep5_required-time' => 'nullable|integer|max:255',

            'childstep6_title' => 'required_with:childstep7_title,childstep7_content|required_if:number_of_childstep,6,7,8,9,10|max:255',
            'childstep6_content' => 'required_with:childstep7_title,childstep7_content|required_if:number_of_childstep,6,7,8,9,10|max:255',
            'childstep6_img' => 'file|image|mimes:jpeg,png,jpg,gif|max:2048',
            'childstep6_required-time' => 'nullable|integer|max:255',

            'childstep7_title' => 'required_with:childstep8_title,childstep8_content|required_if:number_of_childstep,7,8,9,10|max:255',
            'childstep7_content' => 'required_with:childstep8_title,childstep8_content|required_if:number_of_childstep,7,8,9,10|max:255',
            'childstep7_img' => 'file|image|mimes:jpeg,png,jpg,gif|max:2048',
            'childstep7_required-time' => 'nullable|integer|max:255',

            'childstep8_title' => 'required_with:childstep9_title,childstep9_content|required_if:number_of_childstep,8,9,10|max:255',
            'childstep8_content' => 'required_with:childstep9_title,childstep9_content|required_if:number_of_childstep,8,9,10|max:255',
            'childstep8_img' => 'file|image|mimes:jpeg,png,jpg,gif|max:2048',
            'childstep8_required-time' => 'nullable|integer|max:255',

            'childstep9_title' => 'required_with:childstep10_title,childstep10_content|required_if:number_of_childstep,9,10|max:255',
            'childstep9_content' => 'required_with:childstep10_title,childstep10_content|required_if:number_of_childstep,9,10|max:255',
