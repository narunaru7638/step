            ...
            <div class="c-article-list c-article-list--small">
                ...
                <div class="c-article-list__content c-article-list__content--small">
                    <div class="c-article-list__info c-article-list__info--small">
                        <a href="{{ route('steps.category.index', ['id' => $step_new->getCategoryId()]) }}"><p class="c-article-list__category c-article-list__category--small">{{ $step_new->getCategoryName() }}</p></a>
                        <a href="{{ route('profile.show', ['id' => $step_new->getUserId()]) }}"><p class="c-article-list__username c-article-list__username--small">{{ $step_new->getUserName() }}</p></a>
    ...
    <div class="l-sidebar__container">
        ...
        @foreach($steps_rank as $key=>$step_rank)
            ...
            <div class="c-article-list c-article-list--small">
                ...
                <div class="c-article-list__content c-article-list__content--small">
                    <div class="c-article-list__info c-article-list__info--small">
                        <a href="{{ route('steps.category.index', ['id' => $step_rank->getCategoryId()]) }}"><p class="c-article-list__category c-article-list__category--small">{{ $step_rank->getCategoryName() }}</p></a>
                        <a href="{{ route('profile.show', ['id' => $step_rank->getUserId()]) }}"><p class="c-article-list__username c-article-list__username--small">{{ $step_rank->getUserName() }}</p></a>
